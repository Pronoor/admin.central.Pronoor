...
@section('content_header')
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Terms And Conditions::List</h1>
            </div>
            <div class="col-sm-6">
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a type="button" href="{{ route('admin.terms-conditions.edit', $termsCondition->id) }}"
                                            class="btn btn-sm btn-primary">Edit</a>
                                        <a onclick="return confirm('Are you sure to delete')" type="button" href="{{ route('admin.terms-conditions.delete', $termsCondition->id) }}"
