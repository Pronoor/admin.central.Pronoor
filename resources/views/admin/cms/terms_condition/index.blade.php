            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a type="button" href="{{route('admin.terms-conditions.create')}}" class="btn btn-sm btn-primary">Add New
                            Service</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td> 4</td>
                                <td>
                                    <a type="button" href="{{route('admin.terms-conditions.edit',1)}}"
                                       class="btn btn-sm btn-primary">Edit</a>
                                    <a type="button" href="{{route('admin.terms-conditions.delete',1)}}"
