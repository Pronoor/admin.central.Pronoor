            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a type="button" href="{{route('admin.about-us')}}" class="btn btn-sm btn-primary">Back</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        @if(count($errors) > 0 )
                        ...
                        @endif
                        <form method="post" action="{{route('admin.about-us.update',$aboutUsed->id)}}" id="quickFor">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="title">Title</label>
                                    <input type="text" name="title" class="form-control" id="title" value="{{ $aboutUsed->title }}" placeholder="Enter title">
                                </div>
                                <div class="form-group">
