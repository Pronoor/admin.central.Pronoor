            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a type="button" href="{{route('admin.about-us.create')}}" class="btn btn-sm btn-primary">Add
                            New
                            About Us</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td> 4</td>
                                <td>
                                    <a type="button" href="{{route('admin.about-us.edit',1)}}"
                                       class="btn btn-sm btn-primary">Edit</a>
                                    <a type="button" href="{{route('admin.about-us.delete',1)}}"
