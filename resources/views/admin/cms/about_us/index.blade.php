            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a type="button" href="{{ route('admin.about-us.create') }}" class="btn btn-sm btn-primary">Add New About Us</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                @foreach ($aboutUsed as $aboutUs)
                                <tr>
                                    <td>{{ $aboutUs->title }}</td>
                                    <td>{!! $aboutUs->content !!}</td>
                                    <td>
                                        <a type="button" href="{{ route('admin.about-us.edit', $aboutUs->id) }}"
                                            class="btn btn-sm btn-primary">Edit</a>
                                        <a onclick="return confirm('Are you sure to delete')" type="button" href="{{ route('admin.about-us.delete', $aboutUs->id) }}"
