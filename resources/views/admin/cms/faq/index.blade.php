            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a type="button" href="{{route('admin.faq.create')}}" class="btn btn-sm btn-primary">Add New Faq</a>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td>{!! $faq->answer !!}</td>
                                <td>
                                    <a type="button" href="{{route('admin.faq.edit',$faq->id)}}"
                                       class="btn btn-sm btn-primary">Edit</a>
                                    <a onclick="return confirm('Are you sure to delete')" type="button" href="{{route('admin.faq.delete',$faq->id)}}"
