            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <a type="button" href="{{ route('admin.subscribe.create') }}" class="btn btn-sm btn-primary">add Subscribe</a>
                    </div>
                    <div class="card-body">
                        @if (session('status'))
                            ...
                            <tbody>
                                @foreach ($subscribers as $subscriber)
                                    <tr>
                                        ...
                                        <td>
                                            <a type="button" href="{{ route('admin.subscribe.edit', $subscriber->id) }}"
                                                class="btn btn-sm btn-primary">Edit</a>
                                            <a onclick="return confirm('Are you sure to delete')" type="button" href="{{ route('admin.subscribe.delete', $subscriber->id) }}"
